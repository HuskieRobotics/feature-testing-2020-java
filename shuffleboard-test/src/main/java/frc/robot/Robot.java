...
public class Robot extends TimedRobot {
 ...
 // private CvSource source;
  ...
  public void robotInit() {
    ...
    //camera1.addServer("front camera");
    ...
    //CvSource source = CameraServer.getInstance().putVideo("test", 200, 100);

    //Mat output = new Mat();
    //camera1.startAutomaticCapture(usb1);
    //SmartDashboard.putBoolean("res", usb1.setResolution(20,20));

    camera2 = CameraServer.getInstance();

    //UsbCamera usb2 = new UsbCamera("back camera", 1);
    //usb2.setFPS(20);
    //usb2.setResolution(1,1);
    //usb2.setPixelFormat(PixelFormat.kMJPEG);
    //camera2.startAutomaticCapture(usb2);
    /*
